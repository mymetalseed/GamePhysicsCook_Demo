...
bool LineOrientedRectangle(const Line2D& line, const OrientedRectangle& rectanle);
...
bool OrientedRectangleOrientedRectangleSAT(const OrientedRectangle& rect2, const vec2& axis);
